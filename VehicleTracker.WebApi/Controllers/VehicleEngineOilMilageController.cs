...
namespace VehicleTracker.WebApi.Controllers
{
    ...
    public class VehicleEngineOilMilageController : ControllerBase
    {
        ...
        {
            var response = _vehicleEngineOilMilageService.GetAllVehicleEngineOilMilage(vehicleId, pageSize, currentPage);
            return Ok(response);
        }
        ...
        public async Task<ActionResult> Post([FromBody] VehicleEngineOilMilageViewModel vm)
        {
            ...
            var response = await _vehicleEngineOilMilageService.AddNewVehicleEngineOilMilage(vm, userName);
            return Ok(response);
        }
